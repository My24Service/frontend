...
import overviewMixin from "./dashboard_view/overviewMixin"
import {OrderlineService} from "@/models/orders/Orderline"

// The overview page (the mockup's landing page), for both product families:
// it needs no family branch. The nav only offers it to the shltr family.
export default {
