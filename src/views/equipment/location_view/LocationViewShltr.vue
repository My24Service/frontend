        ...
        <div class="col-xxl-3 col-xl-6 col-md-12 mb-4">
          <div class="card w-100 d-flex flex-column h-100 border-0 shadow-sm">
            ...
            <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
              <template v-if="hasQr">
                <div v-if="location.qr_path" class="qr-container mb-3">
                  <BLink
                    class="btn btn-sm btn-outline mb-2" :href="location.qr_path"
                    target="_blank"
                    :title="$trans('Open QR in new tab')">
                    <img :alt="$trans('QR code')" class="qr-code-image img-fluid" :src="location.qr_path" />
                  </BLink>
                  <p class="mb-0">
