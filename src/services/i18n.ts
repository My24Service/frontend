/**
 * Translation, toast and money helpers.
 *
 * Infrastructure rather than a feature: `$trans` reads the page's Django
 * catalogue, the two toasts raise a message through a `create` the caller got
 * from `useToast()`, and `toDinero` is a thin wrapper over dinero.js. None of
 * them touches a store, a model or the router.
 *
